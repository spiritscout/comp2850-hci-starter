...
// Correct imports for extension functions defined in Main.kt (Main.kt has no package)
...
fun Route.taskRoutes() {
    ...
    post("/tasks/{id}/edit") {
        ...
        if (call.isHtmxRequest()) {
            ...
            val status =
                """<div id="status" hx-swap-oob="true">Task updated to "${updated.title}".</div>"""
